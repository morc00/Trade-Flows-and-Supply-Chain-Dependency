...
├── data/
│   ├── raw/                     # Raw mock dataset (generated by script)
│   └── processed/               # Cleaned & feature-engineered dataset
├── scripts/
│   └── generate_mock_data.py    # Generates realistic trade flow dataset
...
1. **Mock Data Generation**: The Python script creates a realistic simulation of global semiconductor trade, embedding tariff rates and disruption risk scores.
